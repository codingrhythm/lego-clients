...
#ifndef PROTOBUF_INCLUDED_lego_2eproto
#define PROTOBUF_INCLUDED_lego_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_lego_2eproto 
...
namespace google {
namespace protobuf {
template<> ::lego::GetRequest* Arena::CreateMaybeMessage<::lego::GetRequest>(Arena*);
template<> ::lego::LegoRecord* Arena::CreateMaybeMessage<::lego::LegoRecord>(Arena*);
template<> ::lego::LegoRecordField* Arena::CreateMaybeMessage<::lego::LegoRecordField>(Arena*);
template<> ::lego::LegoRecordSection* Arena::CreateMaybeMessage<::lego::LegoRecordSection>(Arena*);
template<> ::lego::LegoResponse* Arena::CreateMaybeMessage<::lego::LegoResponse>(Arena*);
template<> ::lego::Page* Arena::CreateMaybeMessage<::lego::Page>(Arena*);
template<> ::lego::Question* Arena::CreateMaybeMessage<::lego::Question>(Arena*);
template<> ::lego::Template* Arena::CreateMaybeMessage<::lego::Template>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace lego {
...
class LegoRecordField : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:lego.LegoRecordField) */ {
 public:
  ...
  inline LegoRecordField* New() const final {
    return CreateMaybeMessage<LegoRecordField>(NULL);
  }

  LegoRecordField* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<LegoRecordField>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class LegoRecordSection : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:lego.LegoRecordSection) */ {
 public:
  ...
  inline LegoRecordSection* New() const final {
    return CreateMaybeMessage<LegoRecordSection>(NULL);
  }

  LegoRecordSection* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<LegoRecordSection>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class LegoRecord : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:lego.LegoRecord) */ {
 public:
  ...
  inline LegoRecord* New() const final {
    return CreateMaybeMessage<LegoRecord>(NULL);
  }

  LegoRecord* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<LegoRecord>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
class LegoResponse : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:lego.LegoResponse) */ {
 public:
  ...
  inline LegoResponse* New() const final {
    return CreateMaybeMessage<LegoResponse>(NULL);
  }

  LegoResponse* New(::google::protobuf::Arena* arena) const final {
    return CreateMaybeMessage<LegoResponse>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) final;
  void MergeFrom(const ::google::protobuf::Message& from) final;
...
#endif  // PROTOBUF_INCLUDED_lego_2eproto
